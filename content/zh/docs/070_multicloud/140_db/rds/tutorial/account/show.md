...
- 菜单导航: 数据库 -> RDS实例 -> 点击名称 -> 点击账号标签页 -> 点击账号名称

 ![RDS实例账号详情](../../../images/rds_account_show.png)
...
{{% tab name="命令行" %}}
```bash
# 查看RDS实例账号02c5634d-40bf-40f2-8212-4773c4dc9f0e详情
$ climc dbinstance-account-show 02c5634d-40bf-40f2-8212-4773c4dc9f0e
+----------------------+--------------------------------------------------------------------------------------------------------------------------+
|        Field         |                                                          Value                                                           |
+----------------------+--------------------------------------------------------------------------------------------------------------------------+
| account              | qj-jd                                                                                                                    |
