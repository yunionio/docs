...
- 菜单导航: 数据库 -> RDS实例 -> 点击名称 -> 点击备份管理标签页 -> 点击备份名称

 ![RDS实例备份详情](../../../images/rds_backup_show.png)
...
{{% tab name="命令行" %}}
```bash
# 查看RDS实例备份4eca9256-f998-402e-83bf-db7b0860c5c3详情
$ climc dbinstance-backup-show 4eca9256-f998-402e-83bf-db7b0860c5c3
+--------------------+--------------------------------------+
|       Field        |                Value                 |
+--------------------+--------------------------------------+
| account            | qj-jd                                |
...
| update_version     | 1                                    |
| updated_at         | 2021-06-22T07:51:57.000000Z          |
+--------------------+--------------------------------------+
```
{{% /tab %}}
{{< /tabs >}}
