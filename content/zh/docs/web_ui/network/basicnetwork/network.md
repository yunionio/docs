...
{{% alert title="注意" color="warning" %}}
仅{{<oem_name>}}平台的IP子网支持更换二层网络。
IP子网未使用时支持更换二层网络。
{{% /alert %}}

**单个IP子网更换二层网络**

1. 单击IP子网右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"更换二层网络"_** 菜单项，弹出更换二层网络对话框。
2. 选择二层网络，完成后，单击 **_"确定"_** 按钮。

**批量更换二层网络**

1. 在IP子网列表中选择一个或多个IP子网，单击列表上方 **_"批量操作"_** 按钮，选择下拉菜单 **_"更换二层网络"_** 菜单项，弹出更换二层网络对话框。
2. 选择二层网络，完成后，单击 **_"确定"_** 按钮。
