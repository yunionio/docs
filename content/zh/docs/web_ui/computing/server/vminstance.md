...
| 操作\平台       | {{<oem_name>}} | VMware    | OpenStack  | ZStack   | DStack   | HCSO       | HCS   | 飞天  | Nutanix | BingoCloud | inCloud Sphere |  Proxmox      |阿里云      | AWS      | Azure    | 华为云        | 腾讯云      | UCloud   | Google   | 天翼云      | 移动云 | 京东云 |
|-------------|----------------|-----------|------------|----------|----------|------------|-------|-----|---------|------------|----------------|----------|----------|----------|------------|----------|----------|----------|----------|-----|-----|-----|
| VNC登录       | 运行             | 运行        | 运行         | 运行       | 运行       | 运行         | 运行    | 支持  | 不支持     | 不支持        | 支持             | 不支持 | 运行       | 不支持      | 不支持      | 运行         | 运行       | 运行       | 不支持      | 不支持      | 不支持 | 不支持 |
| WEB SSH登录   | 所有IP、运行        | 所有IP、运行   | 支持EIP、运行   | 支持EIP、运行 | 支持EIP、运行 | 支持EIP、运行   | 不支持   | 支持  | 不支持     | 不支持        | 支持             | 支持  | 支持EIP、运行 | 支持EIP、运行 | 支持EIP、运行 | 支持EIP、运行   | 支持EIP、运行 | 支持EIP、运行 | 支持EIP、运行 | 支持EIP、运行 | 不支持 | 不支持 |
| 修改属性        | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 重装系统        | 运行、关机          | 运行、关机     | 关机         | 关机       | 关机       | 关机、故障      | 关机、故障 | 支持  | 不支持     | 不支持        | 支持             | 不支持 | 运行、关机    | 运行、关机    | 运行、关机    | 关机、故障      | 运行、关机    | 关机       | 关机       | 关机       | 不支持 | 不支持 |
| 调整配置        | 运行、关机          | 关机        | 关机         | 运行、关机    | 运行、关机    | 关机         | 关机    | 支持  | 关机      | 不支持        | 支持             | 不支持 | 关机       | 关机       | 运行、关机    | 关机         | 关机       | 关机       | 关机       | 关机       | 不支持 | 不支持 |
| 更改项目        | 支持             | 支持        | 支持         | 支持       | 支持       | 支持         | 支持    | 支持  | 支持      | 支持         | 支持             | 支持  | 支持       | 支持       | 支持       | 支持         | 支持       | 支持       | 支持       | 支持       | 不支持 | 不支持 |
| 创建快照        | 支持             | 仅支持创建主机快照 | 支持         | 支持       | 支持       | 支持         | 支持    | 支持  | 不支持     | 不支持        | 不支持            | 不支持        | 支持       | 支持       | 支持       | 支持         | 支持       | 不支持      | 支持       | 支持       | 不支持 | 不支持 |
| 创建备份        | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持        | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 创建相同配置      | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 支持         | 不支持   | 支持  | 不支持     | 不支持        |  支持 | 支持         | 支持       | 支持       | 支持       | 支持       | 支持       | 支持         | 支持       | 支持       | 支持       | 支持       | 不支持 | 不支持 |
| 绑定GPU卡      | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持       | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 设置USB透传     | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持       | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 设置磁盘速度      | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持       | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 更换块存储       | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持       | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 绑定物理CPU     | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持       | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 到期释放        | 支持             | 支持        | 支持         | 支持       | 支持       | 支持         | 支持    | 支持  | 支持      | 支持         | 支持             | 支持         | 支持       | 支持       | 支持       | 支持         | 支持       | 支持       | 支持       | 支持       | 不支持 | 不支持 |
