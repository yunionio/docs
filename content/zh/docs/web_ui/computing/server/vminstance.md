...
- 配置透传设备：是否为虚拟机配置透传设备，启用该项后，支持选择GPU、NPU等类型的设备透传，若选择GPU，还需要选择GPU类型和具体的GPU卡，设置图形GPU后，镜像会过滤出UEFI。
...
| 操作\平台       | {{<oem_name>}} | VMware    | OpenStack  | ZStack   | DStack   | HCSO       | HCS   | 飞天  | Nutanix | BingoCloud | inCloud Sphere |  Proxmox      |H3C      |阿里云      | AWS      | Azure    | 华为云        | 腾讯云      | UCloud   | Google   | 天翼云      | 移动云 | 京东云 |
|-------------|----------------|-----------|------------|----------|----------|------------|-------|-----|---------|------------|----------------|----------|----------|----------|------------|----------|----------|----------|----------|-----|-----|-----|-----|
| VNC登录       | 运行             | 运行        | 运行         | 运行       | 运行       | 运行         | 运行    | 运行  | 不支持     | 不支持        | 运行             | 不支持 | 不支持      | 运行       | 不支持      | 不支持      | 运行         | 运行       | 运行       | 不支持      | 不支持      | 不支持 | 不支持 |
| WEB SSH登录   | 所有IP、运行        | 所有IP、运行   | 支持EIP、运行   | 支持EIP、运行 | 支持EIP、运行 | 支持EIP、运行   | 不支持   | 支持  | 不支持     | 不支持        | 支持             | 支持  | 不支持      | 支持EIP、运行 | 支持EIP、运行 | 支持EIP、运行 | 支持EIP、运行   | 支持EIP、运行 | 支持EIP、运行 | 支持EIP、运行 | 支持EIP、运行 | 不支持 | 不支持 |
| 修改属性        | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 重装系统        | 运行、关机          | 运行、关机     | 关机         | 关机       | 关机       | 关机、故障      | 关机、故障 | 支持  | 不支持     | 不支持        | 支持             | 不支持 | 不支持      | 运行、关机    | 运行、关机    | 运行、关机    | 关机、故障      | 运行、关机    | 关机       | 关机       | 关机       | 不支持 | 不支持 |
| 调整配置        | 运行、关机          | 关机        | 关机         | 运行、关机    | 运行、关机    | 关机         | 关机    | 支持  | 关机      | 不支持        | 支持             | 不支持 | 不支持      | 关机       | 关机       | 运行、关机    | 关机         | 关机       | 关机       | 关机       | 关机       | 不支持 | 不支持 |
| 更改项目        | 支持             | 支持        | 支持         | 支持       | 支持       | 支持         | 支持    | 支持  | 支持      | 支持         | 支持             | 支持  | 支持      | 支持       | 支持       | 支持       | 支持         | 支持       | 支持       | 支持       | 支持       | 不支持 | 不支持 |
| 创建快照        | 支持             | 仅支持创建主机快照 | 支持         | 支持       | 支持       | 支持         | 支持    | 支持  | 不支持     | 不支持        | 不支持            | 不支持        | 不支持      | 支持       | 支持       | 支持       | 支持         | 支持       | 不支持      | 支持       | 支持       | 不支持 | 不支持 |
| 创建备份        | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 创建相同配置      | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 支持         | 不支持   | 支持  | 不支持     | 不支持        |  支持 | 支持         | 不支持      | 支持       | 支持       | 支持       | 支持       | 支持       | 支持         | 支持       | 支持       | 支持       | 支持       | 不支持 | 不支持 |
| 设置透传设备      | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持       | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 设置USB透传     | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持       | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 设置磁盘速度      | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持       | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 更换块存储       | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持       | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 绑定物理CPU     | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持       | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 到期释放        | 支持             | 支持        | 支持         | 支持       | 支持       | 支持         | 支持    | 支持  | 支持      | 支持         | 支持             | 支持         | 支持      | 支持       | 支持       | 支持       | 支持         | 支持       | 支持       | 支持       | 支持       | 不支持 | 不支持 |
| 主机克隆        | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 加入反亲和组      | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 续费          | 不支持            | 不支持       | 不支持        | 不支持      | 不支持      | 支持         | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持      | 不支持      | 支持         | 支持       | 支持       | 不支持      | 不支持      | 不支持 | 不支持 |
| 自动续费设置      | 不支持            | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 支持       | 不支持      | 不支持      | 支持         | 支持       | 支持       | 不支持      | 不支持      | 不支持 | 不支持 |
| 重置密码        | 关机             | 关机        | 运行         | 运行       | 运行       | 关机         | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 关机       | 不支持      | 运行       | 关机         | 关机       | 运行       | 关机       | 关机       | 不支持 | 不支持 |
| 绑定/解绑密钥     | 关机             | 关机        | 仅新建时支持绑定密钥 | 运行       | 运行       | 仅新建时支持绑定密钥 | 不支持   | 支持  | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 关机       | 不支持      | 运行       | 仅新建时支持绑定密钥 | 关机       | -        | 关机       | 不支持      | 不支持 | 不支持 |
| 设置免密登录      | 支持             | 支持        | 支持         | 支持       | 支持       | 支持         | 支持    | 支持  | 支持      | 支持         | 支持             | 支持    | 支持      | 支持       | 支持       | 支持       | 支持         | 支持       | 支持       | 支持       | 不支持      | 不支持 | 不支持 |
| 探测免密登录      | 支持             | 支持        | 支持         | 支持       | 支持       | 支持         | 支持    | 支持  | 支持      | 支持         | 支持             | 支持    | 支持      | 支持       | 支持       | 支持       | 支持         | 支持       | 支持       | 支持       | 不支持      | 不支持 | 不支持 |
| 保存镜像        | 支持             | 支持        | 不支持        | 不支持      | 不支持      | 支持         | 支持    | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 支持       | 支持       | 支持       | 支持         | 支持       | 不支持      | 支持       | 不支持      | 不支持 | 不支持 |
| 挂载/卸载ISO    | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 关联安全组（个数）   | 5              | 不支持       | 5          | 1        | 1        | 5          | 5     | 5   | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 5        | 5        | 1        | 5          | 5        | 1        | 5        | 5        | 不支持 | 不支持 |
| 绑定/解绑弹性公网IP | 仅VPC网络支持       | 不支持       | 支持         | 支持       | 支持       | 支持         | 支持    | 支持  | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 支持       | 支持       | 支持       | 支持         | 支持       | 支持       | 支持       | 支持       | 不支持 | 不支持 |
| 公网IP转EIP    | 不支持            | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 支持       | 支持       | 支持       | 支持         | 支持       | 支持       | 支持       | 支持       | 不支持 | 不支持 |
| 设置源/目标检查    | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 添加/删除备份机    | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 迁移          | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| V2V迁移          | 不支持             | 支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
| 快速恢复        | 支持             | 不支持       | 不支持        | 不支持      | 不支持      | 不支持        | 不支持   | 不支持 | 不支持     | 不支持        | 不支持            | 不支持 | 不支持      | 不支持      | 不支持      | 不支持      | 不支持        | 不支持      | 不支持      | 不支持      | 不支持      | 不支持 | 不支持 |
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"属性设置-修改属性"_** 菜单项，弹出修改属性对话框。
2. 设置引导方式、远程终端协议、显卡型号、主机型号、自动启动。
    - 引导方式默认BIOS，ARM架构只支持UEFI引导方式。
    - 远程终端协议默认VNC，支持选择SPICE。
    - 显卡型号默认Standard，支持选择QXL。
    - 主机型号默认PC，支持选择Q35。
    - 自动启动默认关闭，打开后，当这台虚拟机的宿主机开机后，会立即启动这台虚拟机。
3. 单击 **_"确定"_** 按钮，完成操作。

**批量修改属性**

1. 在虚拟机列表中选择一个或多个虚拟机，单击 **_"批量操作"_** 按钮，选择下拉菜单 **_"属性设置-修改属性"_** 菜单项，弹出修改属性对话框。
2. 设置引导方式、远程终端协议、显卡型号、主机型号、自动启动。
    - 引导方式默认BIOS，ARM架构只支持UEFI引导方式。
    - 远程终端协议默认VNC，支持选择SPICE。
    - 显卡型号默认Standard，支持选择QXL。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"属性设置-创建相同配置"_** 菜单项，弹出创建相同配置对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"属性设置-更改项目"_** 菜单项，弹出更改项目对话框。
...
1. 在虚拟机列表中选择一个或多个虚拟机，单击列表上方 **_"批量操作"_** 按钮，选择下拉菜单 **_"属性设置-更改项目"_** 菜单项，弹出更改项目对话框。
2. 选择域和域下的项目后，单击 **_"确定"_** 按钮，完成操作。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"属性设置-到期释放"_** 菜单项，弹出到期释放对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"属性设置-加入反亲和组"_** 菜单项，弹出加入反亲和组对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"属性设置-主机克隆"_** 菜单项，弹出主机克隆对话框。
2. 设置名称、数量、克隆方式。
...
1. 在虚拟机列表中选择两个及以上虚拟机，单击列表上方**_"批量操作"_** 按钮，选择下拉菜单 **_"属性设置-主机克隆"_** 菜单项，弹出主机克隆对话框。
2. 单击 **_"确定"_** 按钮，批量克隆虚拟机。

#### 续费
在阿里云、华为云、腾讯云、UCloud、京东云平台上申请的包年包月的虚拟机到期后，如果需要继续使用虚拟机资源，需要在虚拟机资源释放之前进行续费操作。

1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"属性设置-续费"_** 菜单项，弹出续费对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"属性设置-自动续费设置"_** 菜单项，弹出设置自动续费对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"配置修改-重装系统"_** 菜单项，弹出重装系统对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"配置修改-调整配置"_** 菜单项，弹出调整配置对话框。
...
1. 在虚拟机列表中选择一个或多个同一个平台的虚拟机，单击列表上方 **_"批量操作"_** 按钮，选择下拉菜单 **_"配置修改-调整配置"_** 菜单项，弹出调整配置对话框。
2. 调整虚拟机的CPU核数、内存，若虚拟机在"关机"状态下可勾选“调整配置后自动启动”，单击 **_"确定"_** 按钮。
3. 若开启了工单，则还需要填入申请原因，单击 **_"提交工单"_** 按钮，提交调整配置工单，等待审批通过后才会成功调整配置。

#### 设置透传设备

该功能用于设置为虚拟机绑定或解绑透传设备，绑定透传设备之前请确保虚拟机所在宿主机上存在透传设备。当虚拟机用于高性能计算、图形显示等用途时，建议绑定GPU卡、NPU卡等。

{{% alert title="注意" color="warning" %}}
- 仅{{<oem_name>}}平台支持绑定、解绑透传设备功能。
- 当宿主机上存在空闲的透传设备时，宿主机上的虚拟机才可以绑定透传设备。
- 批量绑定透传设备操作仅支持关联同种型号的透传设备，批量解绑会取消所有已关联的透传设备。
- 目前仅管理员支持设置透传设备功能。
{{% /alert %}}

**单个虚拟机设置透传设备**

1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"配置修改-设置透传设备"_** 菜单项，弹出设置透传设备对话框。
2. 设置透传设备页面支持绑定和解绑透传设备。
    - 绑定透传设备：勾选是否绑定，并选择透传设备，支持选择为虚拟机绑定多个透传设备，虚拟机关机状态下支持勾选设置成功后自动启动，即绑定透传设备后自动启动虚拟机，单击 **_"确定"_** 按钮。
    - 解绑透传设备：取消勾选是否绑定，取消后，则解绑虚拟机上的所有透传设备，默认勾选设置成功后自动启动，即解绑透传设备后自动启动虚拟机，单击 **_"确定"_** 按钮。
3. 勾选自动启动开关，若开启，设置成功后自动启动，单击 **_"确定"_** 按钮。

**批量为虚拟机设置透传设备**

1. 在虚拟机列表中选择一个或多个{{<oem_name>}}平台上关机状态的虚拟机，单击列表上方 **_"批量操作"_** 按钮，选择下拉菜单 **_"设置透传设备"_** 菜单项，弹出设置透传设备对话框。
2. 设置透传设备页面支持批量绑定和解绑透传设备。
    - 绑定透传设备：设置透传设备选择“关联透传设备”，选择透传设备型号，设置每台虚拟机上绑定的透传设备数量，虚拟机关机状态下支持勾选批量绑定透传设备后自动启动，即绑定透传设备后自动启动虚拟机，单击 **_"确定"_** 按钮。
    - 解绑透传设备：设置透传设备选择“解绑透传设备”，默认勾选批量解绑成功后自动启动，即解绑透传设备后自动启动虚拟机，单击 **_"确定"_** 按钮，批量解绑透传设备。
3. 勾选自动启动开关，若开启，设置成功后自动启动，单击 **_"确定"_** 按钮。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"配置修改-设置USB透传"_** 菜单项，弹出设置USB透传对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"配置修改-修改启动顺序"_** 菜单项，弹出修改启动顺序对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"配置修改-更换块存储"_** 菜单项，弹出更换块存储对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"配置修改-绑定物理CPU"_** 菜单项，弹出绑定物理CPU对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"配置修改-设置磁盘速度"_** 菜单项，弹出设置磁盘速度对话框。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"镜像与备份-创建快照"_** 菜单项，弹出新建快照对话框。
2. 选择快照类别。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"镜像与备份-创建备份"_** 菜单项，弹出新建备份对话框。
2. 选择备份类别。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"网络与安全-修改安全组"_** 菜单项，弹出修改安全组对话框。
2. 在修改安全组对话框中支持关联或取消关联安全组。
...
1. 在虚拟机列表中选择一个或多个虚拟机，单击 **_"批量操作"_** 按钮，选择下拉菜单 **_"网络与安全-修改安全组"_** 菜单项，弹出修改安全组对话框。
2. 在修改安全组对话框中支持关联或取消关联安全组。
    - 关联安全组：选择要绑定的安全组，最多支持5个。如没有符合需求的安全组，可单击“新建安全组”超链接，在弹出的新建安全组页面配置相关参数，单击 “确定” 按钮，创建安全组。
    - 取消关联安全组：取消选择安全组，至少保留一个安全组。
3. 单击 **_"确定"_** 按钮，完成操作。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"网络与安全-绑定弹性公网IP"_** 菜单项，弹出绑定弹性公网IP对话框。
2. 配置以下参数
    - 若绑定方式选择“新建”弹性公网IP，
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"网络与安全-解绑弹性公网IP"_** 菜单项，弹出解绑弹性公网IP对话框。
2. 单击 **_"确定"_** 按钮，完成操作。
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"网络与安全-公网IP转EIP"_** 菜单项，弹出公网IP转EIP对话框。
2. 单击 **_"确定"_** 按钮，完成操作。 
...
1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"网络与安全-设置源/目标检查"_** 菜单项，弹出设置源/目标检查对话框。
...
- 开机状态的虚拟机不支持添加备份机，仅在虚拟机状态为【关机】下可以进行该操作。
{{% /alert %}}

1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"高可用-添加备份机"_** 菜单项，弹出添加备份机对话框。
2. 配置以下参数：
    - 备份机的宿主机：选择备份机的宿主机。
    - 自动启动：设置成功后是否自动启动，开启后虚拟机会在确定后重启。
3. 单击 **_"确定"_** 按钮，虚拟机名称右侧将出现![](../../../images/computing/HA.png)的图标。
...
该功能用于将纳管的VMware主机迁移到内置{{<oem_name>}}私有云主机。

{{% alert title="注意" color="warning" %}}
- VMware主机需要处于关机状态。
- {{<oem_name>}}内置私有云的宿主机和VMware的ESXi宿主机之间网络需要可以互相访问。
- VMware主机对接的经典网络IP子网在{{<oem_name>}}私有云中也需要能分配给虚拟机使用。
- 在{{<oem_name>}}平台创建和VMware主机同配置的虚拟机，并且将VMware主机的虚拟网卡卸载，挂载到新建的{{<oem_name>}}虚拟机上，创建虚拟磁盘，并且将VMware主机的磁盘作为KVM虚拟机磁盘的backing file，启动{{<oem_name>}}虚拟机，远程挂载VMware主机的磁盘，作为{{<oem_name>}}虚拟机的磁盘的backing file，启动成功后，{{<oem_name>}}虚拟机的磁盘内容为VMware虚拟机的磁盘，网络IP是VMware主机的IP。同时，将VMware主机设置为Freeze状态，禁止VMware主机启动，启动后，开始磁盘数据同步，会将{{<oem_name>}}虚拟磁盘底层的VMware虚拟机磁盘数据同步到{{<oem_name>}}虚拟机的上层磁盘文件，磁盘数据同步完成后，{{<oem_name>}}虚拟机不再依赖VMware虚拟机。
- 磁盘数据同步完成后，可以删除原来的VMware虚拟机，完成迁移。
- 如果迁移失败，则需要删除{{<oem_name>}}虚拟机(需确保在回收站清理)。删除后，会自动将虚拟网卡挂载回VMware虚拟机，并且解除VMware主机Freeze状态。
{{% /alert %}}

**单个虚拟机V2V迁移**

1. 在虚拟机页面，单击虚拟机右侧操作列 **_"更多"_** 按钮，选择下拉菜单 **_"高可用-V2V迁移"_** 菜单项，弹出V2V迁移对话框。
2. 迁移类型默认迁移至KVM平台，选择宿主机，单击 **_"确定"_** 按钮，将VMware主机迁移到内置{{<oem_name>}}私有云主机。
...
3. 查看以下信息。
    - 基本信息：包括ID、名称、状态、电源状态、域、项目、主机名、CPU架构、标签、agent安装状态、关联密钥、平台、计费方式、区域、可用区、云账号、创建时间、更新时间、备注；
    - 配置信息：包括操作系统、IP地址、MAC地址、系统镜像、宿主机、安全组、VPC、CPU、内存、系统盘、数据盘、ISO、透传设备、自动启动、最大带宽、监控地址等；
    - 加密：加密密钥、密钥算法、密钥持有者等；
    - 主备机设置：备份机的宿主机、备份机的宿主机状态、备份机状态、备份机同步状态；
    - 其他设置：支持开启或关闭删除保护。
...
- 在虚拟机页面，单击虚拟机名称右侧![](../../../images/computing/refresh.png)的图标，刷新当前资源详情页。
...
该功能用于为虚拟机配置透传网卡，目前仅{{<oem_name>}}平台的虚拟机支持。

1. 在虚拟机页面，单击虚拟机名称项，进入虚拟机详情页面。
2. 单击“网络”页签，进入网络页面。
3. 单击网卡列表上方 **_"添加网卡"_** 按钮，弹出添加网卡对话框。
4. 单击 **_"配置透传网卡"_** 按钮，设置透传网卡，单击 **_"确定"_** 按钮。
...
3. 默认查看以下监控信息：
    - 基础监控：默认获取的监控信息。
        - 支持查看近1小时、近6小时、近12小时、近1周、近1月的性能监控信息，支持设置时间粒度，时间粒度大小与查看的时长有关,支持聚合函数过滤，聚合函数包含最小值、最大值、平均值。
...
该功能用于新建虚拟机开机、关机、重启和同步的定时任务。

1. 在虚拟机页面，单击虚拟机名称项，进入虚拟机详情页面。
2. 单击“定时任务”页签，进入定时任务页面。
3. 配置以下参数：
...
4. 单击 **_"确定"_** 按钮，创建定时任务。
   ...
   - 有效时间：定时任务的有效时间，需要设置一个开始时间和结束时间。
   - 资源类型：默认为虚拟机。
   - 操作动作：支持选择开机、关机、重启、同步。
   - 关联资源：选择具体的虚拟机资源，支持多选。
4. 单击 **_"确定"_** 按钮，完成操作。
